...
const EditTypeEntrepot = ({ onClose,onAjouter, toModify}) => {
  ...
  return (
    <div className={styles.tab}>
      <form onSubmit={handleSubmit}>
        <h2>Modifier Type d'Entrepots/Parcs</h2>
        ...
        (
          <>
            ...
            <span className={filterStyles.container}>
                <InputField display="labelontop" label="Type Entrepot/Parc" size="extralarge" type="text" value={type} onChange={(e) => setType(e.target.value)} />
            </span>
            </div>
...
export default EditTypeEntrepot;